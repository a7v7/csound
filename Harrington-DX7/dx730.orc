...
;--------------------Algorithm 30----------------------------------;
                if      (k1fin+k2fin+k3fin+k6fin) > 0 kgoto output
...
output:
     ...
     k6gate    tablei    k6phs,iampfn
        ...
        a5sig   init    0                ;initialize for feedback
        a5phs   phasor  i5hz    ;ops to be modulated must use phase modulation
        a5sig   tablei  a5phs+a5sig*(.2*ifeed),1,1,0,1
        a5sig   =       a5sig*k5gate
        ...
        a1sig   oscili  k1gate,i1hz,1
                ...
                out     (a1sig+a2sig+a3sig+a6sig)*ipkamp
                endin
