...
;--------------------Algorithm 18----------------------------------;
                if      k1fin > 0 kgoto output  ;test carrier sigs
...
output:
     ...
     k6gate    tablei    k6phs,idevfn
        ...
        a6sig   oscili  k6gate,i6hz,1   ;unmodulated op; oscili is ok here.
        ...
        a3phs   phasor  i3hz
        a3sig   tablei  a3phs+a3sig*ifeed,1,1,0,1
        a3sig   =       a3sig*k3gate

        a2sig   oscili  k2gate,i2hz,1

        a1phs   phasor  i1hz
        a1sig   tablei  a1phs+a2sig+a3sig+a4sig,1,1,0,1
        a1sig   =       a1sig*k1gate
