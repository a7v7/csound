...
;--------------------Algorithm 25----------------------------------;
                if      (k1fin+k2fin+k3fin+k4fin+k5fin) > 0 kgoto output
...
output:
     ...
     k6gate    tablei    k6phs,idevfn
        ...
        a6phs   phasor  i6hz    ;ops to be modulated must use phase modulation
        a6sig   tablei  a6phs+a6sig*(.2*ifeed),1,1,0,1
        a6sig   =       a6sig*k6gate
        ...
        a1sig   oscili  k1gate,i1hz,1
                ...
                out     (a1sig+a2sig+a3sig+a4sig+a5sig)*ipkamp
                endin
