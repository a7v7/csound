...
f17     0       32      -2
;OUTLVL   KEYVEL   EGR1   EGR2   EGR3   EGR4   EGL1   EGL2   EGL3   EGL4
 57       0        78     95     70     80     99     96     75     0
;AMS      FIXED?   FREQ   DET    RSC
 0        0        2      0      7
                                                
;====================================================================;
;                       Yamaha DX7 Algorithm 6                       ;
;                                                                    ;
...
;====================================================================;
t 0.000 120.000
i1.00 0.000 0.750 63 64      0      0      0      0
12    13       14       15    16      17     2      15000
3     8        4        6     10      9      11     7
i1.01 0.750 0.250 68 64
i1.02 1.000 2.000 73 64
i1.03 3.000 0.250 72 64
i1.04 3.250 0.250 68 64
i1.05 3.500 0.250 65 64
i1.06 3.750 0.250 70 64
i1.07 4.000 1.750 75 64
i1.08 5.750 0.250 75 64
i1.09 6.000 2.000 79 64
f0    9
e
