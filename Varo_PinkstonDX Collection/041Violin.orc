...
idur           =              abs(p3)
inote          =              p4
ibase          =              (exp((inote/12) * log(2))/log(2.71828183)) * 4.0875
iroct          =              octcps(p4)
irbase         =              octpch(4.09)          
...
;====================================================================
carrier: if       (k1fin + k3fin) > 0 kgoto structure
               turnoff
...
;====================================================================
;MODULATION SECTION- DETERMINES WHAT'S MODULATED AND WHAT'S NOT.
;====================================================================
...
a2sig          init           0
a2phs          phasor         i2hz
a2sig          tablei         a2phs+a2sig*ifeed,1,1,0,1
a2sig          =              a2phs*k2gate
