;REVERBERATION USING LOTS OF TAPS
;INSTR 1 IS MONO IN, INSTR 2 IS STEREO IN
;I'VE INCLUDED A SAMPLE SCORE, AND SINCE IT'S
;TRICKY TO MAKE PARAMETERS, A C PROGRAM TO
;GENERATE SCOREFILES
